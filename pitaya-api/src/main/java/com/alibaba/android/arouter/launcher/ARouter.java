...
public final class ARouter {
    ...
    public Object navigation(android.app.Fragment fragment, Postcard postcard, int requestCode, NavigationCallback callback) {
        return _ARouter.getInstance()._navigation(fragment, postcard, requestCode, callback);
    }
