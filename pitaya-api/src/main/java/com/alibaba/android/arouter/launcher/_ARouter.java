...
final class _ARouter {
    ...
    private _ARouterEx mARouterEx = new _ARouterEx();
    ...
    protected Object _navigation(final Fragment fragment, final Postcard postcard, final int requestCode, final NavigationCallback callback) {
        final Context context = (null == fragment.getActivity() ? mContext : fragment.getActivity());
        // Need start for result
        return mARouterEx._navigation(context, interceptorService, fragment, postcard, requestCode, callback);
    }

    protected Object _navigation(final android.support.v4.app.Fragment supportFragment, final Postcard postcard, final int requestCode, final NavigationCallback callback) {
        final Context context = (null == supportFragment.getActivity() ? mContext : supportFragment.getActivity());

        return mARouterEx._navigation(context, interceptorService, supportFragment, postcard, requestCode, callback);
    }
